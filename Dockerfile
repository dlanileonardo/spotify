...
RUN apt-get update && \
    DEBIAN_FRONTEND=noninteractive apt-get -y install alsa-utils libasound2-plugin-equal libasound2-plugin-bluez bluez-alsa-utils gettext curl ca-certificates && \
